...
Gem::Specification.new do |s|
  s.name = %q{vilango-acts-as-list}
  s.version = "0.1.5"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Gerwin Brunner, Andreas Rami, Vilango GmbH"]
  s.date = %q{2010-04-23}
  s.description = %q{Gem version of acts_as_list Rails plugin.}
  s.email = %q{gems (at) vilango (dot) com}
  s.extra_rdoc_files = ["lib/acts_as_list.rb", "README", "tasks/deployment.rake"]
  s.files = ["vilango-acts-as-list.gemspec", "lib/acts_as_list.rb", "Manifest", "README", "tasks/deployment.rake", "test/list_test.rb"]
  s.has_rdoc = true
